        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-up">
            ...
            <p className="mt-4 text-base text-muted-foreground max-w-lg leading-relaxed">
              Trusted dental surgon in Okhla Delhi— offering painless root canal treatment, dental implants, cosmetic treatment, Hydra Facials, PRP, and Botox at Metro Star Hospital, Jamia Nagar.
            </p>
